...
public class SimpleMaze3dGenerator implements Maze3dGenerator  {
	...
	public Maze3d generate(int h, int r, int c) {
		...
		case 1:
			if(pos.getX() >  maze.getExit().getX() && pos.getX() > 0)
				pos.setX(pos.getX() - 1);
			else if(pos.getX() < maze.getExit().getX() && pos.getX() < maze.getColumn())
				pos.setX(pos.getX() + 1);
			else
				break;
